...
import { tips as msgtips, modal, input as Input, wrapItem } from 'component/client'
...
//点击添加进出现的 modal
const ModalInner = wrapItem(
  <div className="modal">
    <div className="modal-head b-b"><h2 >添加</h2><Icon src="circle" className="my-icon modal-clone" /></div>
...
//点击编辑进出现的 modal
const ModalEdit = wrapItem(
  <div className="modal"  data-id=''>
    <div className="modal-head b-b"><h2 >编辑</h2><Icon src="circle" className="my-icon modal-clone" /></div>
    <div className="modal-main" >
      {editForm.render()}
    </div>
    <div className="modal-foot b-t">
...
//点击删除出现的 modal
const ModalDel = wrapItem(
  <div className="modal">
    <div className="modal-head"><h2 className="disN">确认框</h2><Icon src="circle" className="my-icon modal-clone" /></div>
